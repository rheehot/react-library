...
export default function UserForm(props: RouteComponentProps) {
    ...
    return (
        <div className="component-wrap">
            <form>
                <InputItem labelText="아이디" onChangeHandler={idChangeHandler} inputValue={id}/>
                <InputItem labelText="이름" onChangeHandler={nameChangeHandler} inputValue={name}/>
                <InputItem labelText="이메일" onChangeHandler={emailChangeHandler} inputValue={email}/>
